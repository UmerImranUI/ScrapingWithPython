...
class BooksItem(scrapy.Item):
    ...
    price = scrapy.Field(
        input_processor=MapCompose(get_price),    #map compose breaks the value to string, bcz input processor generate as list
        output_processor=TakeFirst()              #it takes first item present in the tags.
    )
